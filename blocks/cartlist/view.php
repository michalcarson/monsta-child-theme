 ...
 */
function monsta_render_cartlist($attributes)
{
    wp_enqueue_style(
        'monsta-cartlist-css',
        get_stylesheet_directory_uri() . '/blocks/cartlist/view.css',
        ['monsta-widgets-css'],
        false,
        'all'
    );
    ...
    wp_enqueue_script(
        'monsta-cartlist-script',
        get_stylesheet_directory_uri() . '/blocks/cartlist/view.js',
    ...
    return sprintf('<div id="monsta_cartlist" %1$s></div>', $wrapper_attributes);
}
